...
and raw target actions. Used with a plain torch DataLoader inside
GenericDataModule for decoder-only training (FlowFeatureTrainer) — no images,
no episode builder, no encoder.
"""
