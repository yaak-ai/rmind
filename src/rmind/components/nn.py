...
_default_linear_weight_init_fn = partial(nn.init.xavier_uniform_)
_default_linear_bias_init_fn = partial(nn.init.constant_, val=0.0)
...
class Linear(nn.Linear):
    def __init__(
        self,
        *args: Any,
        weight_init_fn: Callable[[Tensor], Any] = _default_linear_weight_init_fn,
        bias_init_fn: Callable[[Tensor], Any] = _default_linear_bias_init_fn,
        **kwargs: Any,
    ) -> None:
